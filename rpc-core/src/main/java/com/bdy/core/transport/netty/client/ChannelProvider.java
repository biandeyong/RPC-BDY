...
import com.bdy.core.codec.CommonDecoder;
import com.bdy.core.codec.CommonEncoder;
import com.bdy.core.serializer.CommonSerializer;
    ...
    public static Channel get(InetSocketAddress inetSocketAddress) {
        bootstrap.handler(new ChannelInitializer<SocketChannel>() {
            ...
            protected void initChannel(SocketChannel ch) {
                ...
                /*自定义序列化编解码器*/
                // RpcResponse -> ByteBuf
                pipeline.addLast(new ObjectDecoder(1024 * 1024, ClassResolvers.cacheDisabled((this.getClass().getClassLoader()))));//反序列化
